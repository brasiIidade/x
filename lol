...
local function CreateLoader()
    ...
    CenterContainer.Size = UDim2.new(0, LoaderConfig.Sizes.BarWidth, 0, 300)
    ...
    LogoShadow.Name = "Glow"
    LogoShadow.AnchorPoint = Vector2.new(0.5, 0.5)
    LogoShadow.Position = UDim2.new(0.5, 0, 0.5, 0)
    LogoShadow.Size = UDim2.new(1, 80, 1, 80)
    LogoShadow.BackgroundTransparency = 1
    LogoShadow.Image = "rbxassetid://6015897843"
    LogoShadow.ImageColor3 = LoaderConfig.Colors.Accent
...
local function RunLoader()
    ...
    TweenService:Create(UI.Background, FadeInInfo, {BackgroundTransparency = 0.05}):Play()
    TweenService:Create(UI.Logo, FadeInInfo, {ImageTransparency = 0}):Play()
    TweenService:Create(UI.LogoShadow, FadeInInfo, {ImageTransparency = 0.8}):Play()
    ...
    local steps = {
        {text = "Checando integridade...", progress = 0.15, wait = 0.4},
        {text = "Conectando ao servidor...", progress = 0.35, wait = 0.6},
        {text = "Baixando assets...", progress = 0.60, wait = 0.5},
        {text = "Aplicando configurações...", progress = 0.80, wait = 0.4},
        {text = "Finalizando...", progress = 1.0, wait = 0.5}
    }
    ...
    TweenService:Create(UI.LogoShadow, FadeOutInfo, {ImageTransparency = 1}):Play()
