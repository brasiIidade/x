...
--// ui
local Config = ... or {}
if Config.Tema == nil then Config.Tema = "Dark" end
if Config.Botao == nil then Config.Botao = true end

local main = UI:CreateWindow({
    Title = "michigun.xyz",
    Icon = "https://cdn.discordapp.com/attachments/1460824919758868501/1464980838298157251/1000060559.png?ex=69777139&is=69761fb9&hm=aef5ea42e43147523e9e427daaf9c6735d3effec13a7cc9d923485e4db2e48ff&",
    Author = "por @fp3",
    Folder = "michigun.xyz",
...
local MainSection = criarsection(Char, "Principal", "Alterar skin (Você)", "lucide:shirt", true)

MainSection:Paragraph({
    Title = "Observação",
    Desc = "A skin aplicada é visual (Client-Sided).",
    Color = "Blue",
...
MainSection:Input({
    Title = "Nome / ID",
    Desc = "Digite o nome ou ID do usuário",
    Value = "",
...
local OthersSection = criarsection(Char, "Outros Jogadores", "Modificar terceiros", "lucide:users", false)

OthersSection:Input({
    Title = "Nome do Alvo",
    Desc = "Parte do nome do jogador alvo",
    Value = "",
    InputIcon = "lucide:user-search",
    Placeholder = "Ex: michigun",
    Callback = function(input)
...
OthersSection:Input({
    Title = "Skin desejada (Nome/ID)",
    Desc = "Skin para aplicar no alvo",
    Value = "",
...
g2:Button({
    Title = "Restaurar Alvo",
    Desc = "Reseta o jogador alvo",
...
OthersSection:Button({
    Title = "Aplicar Favorito Selecionado no Alvo",
    Desc = "Usa a skin selecionada abaixo no alvo",
    Icon = "lucide:star",
    Callback = function()
...
CreateActionMenu = function()
    ...
    local actions = {
        {
            Title = "Favoritar skin atual (Local)",
            Desc = "Salva o ID que VOCÊ está usando",
            Icon = "lucide:save",
            Callback = function()
                if _G.Avatar and _G.Avatar.SaveSkin then
                    _G.Avatar.SaveSkin(targetInput) 
                    notificar("Skin salva", 3, "lucide:check")
                    RefreshList()
                end
                CreateActionMenu()
            end
