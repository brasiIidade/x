...
local FPS_HIGH   = Color3.fromRGB(140, 255, 200)  -- menta fria
local FPS_MID    = Color3.fromRGB(200, 160, 255)  -- lilás suave
local FPS_LOW    = Color3.fromRGB(255, 100, 120)  -- rosa-coral escuro

local PING_LOW   = Color3.fromRGB(100, 220, 200)  -- ciano apagado
local PING_MID   = Color3.fromRGB(180, 140, 255)  -- violeta
local PING_HIGH  = Color3.fromRGB(255, 90,  110)  -- vermelho rosado
...
local DISCORD_PALETTE = {
    Color3.fromRGB( 88, 101, 242),   -- blurple (Discord original)
    Color3.fromRGB(140,  80, 255),   -- roxo profundo
    Color3.fromRGB(200,  60, 220),   -- magenta escuro
    Color3.fromRGB(255,  80, 130),   -- rosa quente
    Color3.fromRGB(255, 140,  80),   -- laranja suave
    Color3.fromRGB(100, 200, 255),   -- azul céu frio
    Color3.fromRGB( 70, 180, 200),   -- ciano escuro
    Color3.fromRGB( 88, 101, 242),   -- volta ao blurple (fecha o loop suave)
}

local CYCLE_DURATION = 6

local function discordColor(t)
    local count   = #DISCORD_PALETTE - 1          -- número de segmentos
    local scaled  = t * count                      -- posição float na paleta
    local idx     = math.floor(scaled) + 1         -- índice do segmento atual
    local frac    = scaled - math.floor(scaled)    -- fração dentro do segmento

    idx = math.clamp(idx, 1, count)
...
do
    ...
    local fp3Tag  = main:Tag({
        Title  = "@fp3",
        Radius = 20,
        Icon   = "rbxassetid://115249452401470",
        Color  = DISCORD_PALETTE[1],
    })
    ...
    Conn:add(RunService.RenderStepped:Connect(function()
        ...
        fp3Tag:SetColor(discordColor(t))
    end), "tags")
