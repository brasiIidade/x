...
local function LoadPathMap()
    local url = BaseURL .. "files.lua?t=" .. tostring(os.time())
...
do
    ...
    local ToggleAim = MainSection:Toggle({
        ...
        Callback = function(state) 
            ...
            if state then
                if _G.StartSilentAim then _G.StartSilentAim() end
                notificar("Ativado", 2, "lucide:check-circle")
            else
                if _G.StopSilentAim then _G.StopSilentAim() end
                notificar("Desativado", 2, "lucide:x-circle")
            end
        end
    })
    ...
    FocusSection:Toggle({
        ...
        Callback = function(state)
            ...
            notificar("Modo Foco: " .. (state and "Ativado" or "Desativado"), 2, "lucide:alert-circle")
        end
    })
    ...
    LogicSection:Dropdown({
        ...
        Values = { "Random", "Head", "HumanoidRootPart", "UpperTorso", "Torso" },
        Value = {"Random"},
        Multi = true,
        AllowNone = true,
