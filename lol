...
local WC = Workspace.WaitForChild
local FFC = game.FindFirstChild -- Manter game aqui pois FFC é método genérico, ou usar o do workspace
            ...
            task.spawn(function()
                while loopAtivo do
                    ...
                    if alvoParaEnviar then
                        local args2 = { alvoParaEnviar.Name, "100000000000" }
