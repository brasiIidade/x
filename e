...
local function RunLoader()
    ...
    local steps = {
        {text = "Checando...", progress = 0.15, wait = 0.4},
        {text = "Bugs? denuncie!", progress = 0.35, wait = 0.6},
        {text = "Sugestões? Envie-nos!", progress = 0.60, wait = 0.5},
        {text = "Finalizando...", progress = 0.80, wait = 0.4},
        {text = "Executando...", progress = 1.0, wait = 0.5}
    }
