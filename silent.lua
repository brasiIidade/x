...
local function toUpper(str)
    ...
    return (str:upper():gsub(".", function(c) return upperMap[c] or c end))
end
...
_G.StartSilentAim = function()
    ...
    HeadBillboard.Size = UDim2.new(0, 500, 0, 500) 
    HeadBillboard.StudsOffset = Vector3New(0, 3, 0)
    ...
    InfoRow.Size = UDim2.new(0, 0, 0, 16)
    InfoRow.AutomaticSize = Enum.AutomaticSize.X
    ...
    TeamLabel.AutomaticSize = Enum.AutomaticSize.XY
    ...
    WeaponLabel.AutomaticSize = Enum.AutomaticSize.XY
    WeaponLabel.Font = Enum.Font.Gotham
    WeaponLabel.TextSize = 11
    WeaponLabel.TextColor3 = Color3.fromRGB(180, 180, 180)
    WeaponLabel.LayoutOrder = 3
    WeaponLabel.Parent = InfoRow

    local HealthContainer = Instance.new("Frame")
    HealthContainer.Name = "HealthContainer"
    HealthContainer.BackgroundTransparency = 1
    HealthContainer.AutomaticSize = Enum.AutomaticSize.XY
    HealthContainer.LayoutOrder = 4
    HealthContainer.Parent = MainContainer

    local HPText = Instance.new("TextLabel")
    HPText.Name = "HPText"
    HPText.BackgroundTransparency = 1
    HPText.AutomaticSize = Enum.AutomaticSize.XY
