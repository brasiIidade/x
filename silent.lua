...
_G.StartSilentAim = function()
    ...
    BackgroundBar.Size = UDim2.new(1, 0, 0, 40)
    ...
    WeaponLabel.Size = UDim2.new(1, -12, 0, 15)
    WeaponLabel.Position = UDim2.new(0, 6, 0, 6)
    ...
    HealthBarBack.Size = UDim2.new(1, -12, 0, 4)
    HealthBarBack.Position = UDim2.new(0, 6, 1, -10)
