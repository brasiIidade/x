    ...
    if Config and Config.Enabled and State.Part then
        ...
        if math.random(1, 100) <= Config.HitChance then
            ...
            elseif isProjectileRemote(self) then
                -- Handle Projectile remote: (HumanoidRootPart, Vector3 position)
