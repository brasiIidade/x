...
local main = UI:CreateWindow({
    Title = "michigun.xyz",
    Icon = "https://cdn.discordapp.com/attachments/1460824919758868501/1460825713694474459/avatar.png?ex=6976d3f6&is=69758276&hm=15a5f68872d5cef42c985907119c3be89a2d3de4c3da0f42f107c0818e8e0a50&",
    Author = "por @fp3",
    Folder = "michigun.xyz",
...
ThemeSection:Input({
    ...
    Desc = "Insira o link da imagem ou ID do Roblox (assetid)",
    Icon = "lucide:image",
    Placeholder = "rbxassetid://...",
    Value = "",
    Flag = "ImagemDeFundo",
    Callback = function(v)
        if main and main.SetBackgroundImage then
            main:SetBackgroundImage(v)
        end
    end
})

ThemeSection:Slider({
    Title = "Transparência da imagem",
    Icons = {
        From = "lucide:image-plus",
        To = "lucide:image-minus",
    },
    Value = { Min = 0, Max = 1, Default = 0 },
    Step = 0.05,
    Flag = "TransparenciaDaImagemDeFundo",
    Callback = function(v)
        if main and main.SetBackgroundImageTransparency then
            main:SetBackgroundImageTransparency(v)
        end
    end
})
