local LoaderConfig = {
    Title = "michigun.xyz",
    LogoId = "rbxassetid://88026679106109", 
...
local function CreateLoader()
    ...
    ScreenGui.Name = "MichigunModernUI"
    ...
    Background.BackgroundColor3 = LoaderConfig.Colors.Background
    Background.BorderSizePixel = 0
    Background.BackgroundTransparency = 1
    Background.Parent = ScreenGui

    local bgPattern1 = Instance.new("ImageLabel")
    bgPattern1.Name = "TechPattern1"
    bgPattern1.Size = UDim2.new(2, 0, 2, 0)
    bgPattern1.Position = UDim2.new(-0.5, 0, -0.5, 0)
    bgPattern1.Image = "rbxassetid://9668137381"
    bgPattern1.ImageColor3 = LoaderConfig.Colors.Glow
    bgPattern1.ImageTransparency = 1
    bgPattern1.ScaleType = Enum.ScaleType.Tile
    bgPattern1.TileSize = UDim2.new(0, 256, 0, 256)
    bgPattern1.BackgroundTransparency = 1
    bgPattern1.ZIndex = 0
    bgPattern1.Parent = Background

    local bgPattern2 = bgPattern1:Clone()
    bgPattern2.Name = "TechPattern2"
    bgPattern2.Position = UDim2.new(0, 0, 0, 0)
    bgPattern2.ImageTransparency = 1
    bgPattern2.ZIndex = 0
    bgPattern2.Parent = Background

    local EdgeGlow = Instance.new("ImageLabel")
    EdgeGlow.Name = "EdgeGlow"
    EdgeGlow.Size = UDim2.new(1.1, 0, 1.1, 0)
    EdgeGlow.Position = UDim2.new(0.5, 0, 0.5, 0)
    EdgeGlow.AnchorPoint = Vector2.new(0.5, 0.5)
    EdgeGlow.BackgroundTransparency = 1
    EdgeGlow.Image = "rbxassetid://1084205023"
    EdgeGlow.ImageColor3 = LoaderConfig.Colors.Glow
    EdgeGlow.ImageTransparency = 1
    EdgeGlow.ZIndex = 2
    EdgeGlow.Parent = Background

    local CenterContainer = Instance.new("Frame")
    CenterContainer.Name = "Container"
    CenterContainer.Size = UDim2.new(0, LoaderConfig.Sizes.BarWidth, 0, 350)
    CenterContainer.Position = UDim2.new(0.5, 0, 0.52, 0) 
    CenterContainer.AnchorPoint = Vector2.new(0.5, 0.5)
    CenterContainer.BackgroundTransparency = 1
    CenterContainer.ZIndex = 5
    CenterContainer.Parent = Background

    local Logo = Instance.new("ImageLabel")
    Logo.Name = "Logo"
    Logo.Size = UDim2.new(0, LoaderConfig.Sizes.LogoSize, 0, LoaderConfig.Sizes.LogoSize)
    Logo.Position = UDim2.new(0.5, 0, 0.25, 0)
    Logo.AnchorPoint = Vector2.new(0.5, 0.5)
    Logo.Image = LoaderConfig.LogoId
    ...
    Title.TextSize = 28
    Title.TextColor3 = LoaderConfig.Colors.Accent
    ...
    BarShadow.Size = UDim2.new(1, 30, 0, 20)
    BarShadow.Position = UDim2.new(0.5, 0, 0.75, 0)
    BarShadow.AnchorPoint = Vector2.new(0.5, 0.5)
    BarShadow.Image = "rbxassetid://6015897843"
    BarShadow.ImageColor3 = LoaderConfig.Colors.Glow
    BarShadow.BackgroundTransparency = 1
    BarShadow.ImageTransparency = 1
    BarShadow.ZIndex = 4
    BarShadow.Parent = CenterContainer
    ...
    BarBG.BackgroundColor3 = LoaderConfig.Colors.BarBg
    ...
    BarFill.BackgroundColor3 = LoaderConfig.Colors.Accent
    ...
    BarGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, LoaderConfig.Colors.Secondary),
        ColorSequenceKeypoint.new(0.5, LoaderConfig.Colors.Accent),
        ColorSequenceKeypoint.new(1, LoaderConfig.Colors.Secondary)
    }
    BarGradient.Rotation = 45
    BarGradient.Parent = BarFill

    local BarSpark = Instance.new("ImageLabel")
    BarSpark.Name = "Spark"
    BarSpark.Size = UDim2.new(0, 30, 0, 30)
    BarSpark.AnchorPoint = Vector2.new(0.5, 0.5)
    BarSpark.Position = UDim2.new(1, 0, 0.5, 0)
    BarSpark.Image = "rbxassetid://6015897843"
    BarSpark.ImageColor3 = LoaderConfig.Colors.Accent
    BarSpark.BackgroundTransparency = 1
    BarSpark.ImageTransparency = 1
    BarSpark.ZIndex = 6
    BarSpark.Parent = BarFill

    local StatusText = Instance.new("TextLabel")
    StatusText.Name = "Status"
    StatusText.Text = "Initializing..."
    StatusText.Size = UDim2.new(1, 0, 0, 20)
    StatusText.Position = UDim2.new(0.5, 0, 0.88, 0)
    StatusText.AnchorPoint = Vector2.new(0.5, 0.5)
    StatusText.BackgroundTransparency = 1
    StatusText.Font = Enum.Font.GothamMedium
    StatusText.TextSize = 14
    StatusText.TextColor3 = LoaderConfig.Colors.Text
...
local function RunLoader()
    ...
    local SlideUpInfo = TweenInfo.new(1.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
    local PulseInfo = TweenInfo.new(2.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
    
    TweenService:Create(UI.Background, FadeInInfo, {BackgroundTransparency = 0}):Play()
    TweenService:Create(UI.EdgeGlow, FadeInInfo, {ImageTransparency = 0.75}):Play()
    TweenService:Create(UI.BgPat1, FadeInInfo, {ImageTransparency = 0.96}):Play()
    TweenService:Create(UI.BgPat2, FadeInInfo, {ImageTransparency = 0.97}):Play()
    
    TweenService:Create(UI.Container, SlideUpInfo, {Position = UDim2.new(0.5, 0, 0.5, 0)}):Play()
    
    TweenService:Create(UI.Logo, FadeInInfo, {ImageTransparency = 0}):Play()
    TweenService:Create(UI.Logo, PulseInfo, {Size = UDim2.new(0, LoaderConfig.Sizes.LogoSize * 1.05, 0, LoaderConfig.Sizes.LogoSize * 1.05)}):Play()
    
    TweenService:Create(UI.Title, FadeInInfo, {TextTransparency = 0}):Play()
    TweenService:Create(UI.BarShadow, FadeInInfo, {ImageTransparency = 0.8}):Play()
    TweenService:Create(UI.BarBG, FadeInInfo, {BackgroundTransparency = 0}):Play()
    TweenService:Create(UI.BarFill, FadeInInfo, {BackgroundTransparency = 0}):Play()
    TweenService:Create(UI.BarSpark, FadeInInfo, {ImageTransparency = 0.2}):Play()
    TweenService:Create(UI.Status, FadeInInfo, {TextTransparency = 0}):Play()

    local startTime = tick()
    local connection
    connection = RunService.Heartbeat:Connect(function()
        if not UI.Gui.Parent then connection:Disconnect() return end
        local t = tick() - startTime
        UI.BgPat1.Position = UDim2.new(-0.5 + (t*0.02)%0.5, 0, -0.5 + (t*0.01)%0.5, 0)
        UI.BgPat2.Position = UDim2.new((t*-0.015)%0.5, 0, (t*0.025)%0.5, 0)
        UI.BarGradient.Offset = Vector2.new(math.cos(t*2)*0.8, 0)
        UI.BarSpark.Size = UDim2.new(0, 30 + math.sin(t*5)*5, 0, 30 + math.sin(t*5)*5)
    end)

    task.wait(1.5)

    local steps = {
        {text = "Inicializando...", progress = 0.15, wait = 0.6},
        {text = "Carregando framework...", progress = 0.35, wait = 0.8},
        {text = "Bugs? Reporte-os!", progress = 0.55, wait = 1},
        {text = "Sugestões? Envie-nos!", progress = 0.75, wait = 1},
        {text = "Finalizando...", progress = 0.92, wait = 0.5},
        {text = "Carregando UI...", progress = 1.0, wait = 0.6}
    }

    for i, step in ipairs(steps) do
        TweenService:Create(UI.Status, TweenInfo.new(0.25), {TextTransparency = 1}):Play()
        task.wait(0.25)
        UI.Status.Text = step.text
        TweenService:Create(UI.Status, TweenInfo.new(0.25), {TextTransparency = 0}):Play()
        
        local progressTween = TweenService:Create(UI.BarFill, 
            TweenInfo.new(step.wait, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), 
            {Size = UDim2.new(step.progress, 0, 1, 0)}
        )
        progressTween:Play()
        
        if i == #steps then progressTween.Completed:Wait() else task.wait(step.wait * 0.8) end
    end

    task.wait(0.5)

    local FadeOutInfo = TweenInfo.new(0.8, Enum.EasingStyle.Quint, Enum.EasingDirection.In)
    local ZoomOutInfo = TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.In)
    
    TweenService:Create(UI.Background, FadeOutInfo, {BackgroundTransparency = 1}):Play()
    TweenService:Create(UI.EdgeGlow, FadeOutInfo, {ImageTransparency = 1}):Play()
    TweenService:Create(UI.BgPat1, FadeOutInfo, {ImageTransparency = 1}):Play()
    TweenService:Create(UI.BgPat2, FadeOutInfo, {ImageTransparency = 1}):Play()
    TweenService:Create(UI.Logo, FadeOutInfo, {ImageTransparency = 1}):Play()
    TweenService:Create(UI.Title, FadeOutInfo, {TextTransparency = 1}):Play()
    TweenService:Create(UI.BarShadow, FadeOutInfo, {ImageTransparency = 1}):Play()
    TweenService:Create(UI.BarBG, FadeOutInfo, {BackgroundTransparency = 1}):Play()
    TweenService:Create(UI.BarFill, FadeOutInfo, {BackgroundTransparency = 1}):Play()
    TweenService:Create(UI.BarSpark, FadeOutInfo, {ImageTransparency = 1}):Play()
    TweenService:Create(UI.Status, FadeOutInfo, {TextTransparency = 1}):Play()
    
    TweenService:Create(UI.Container, ZoomOutInfo, {Position = UDim2.new(0.5, 0, 0.4, 0), Size = UDim2.new(0, LoaderConfig.Sizes.BarWidth * 0.8, 0, 300)}):Play()
...
if executorName then
    ...
    if string.find(lowerName, "xeno") or string.find(lowerName, "solara") then
        LocalPlayer:Kick("Seu executor não tem suporte para rodar o michigun.xyz. Utilize outro executor como Delta no celular ou Bunni no PC.")
    end
end
...
Notify("michigun.xyz", "Script sem key, por enquanto. Aproveite.", 5)
...
do
    ...
    AboutTab:Section({
        Title = [[
- [+] Local [Tevez]
- [+] Enviar mensagens [Tevez] (burla a restrição de chat, mostra para todos)
- [+] Modo afk [Tevez]
...
do
    ...
    local ID_SOUCRE = 129890257340707
...
JogosTab:Button({
        ...
        Icon = "lucide:link",
        Callback = function()
            ConfirmarAcao("EB do Soucre", ID_SOUCRE)
        end
    })
end
...
do
    ...
    local KeybindAim = SilentTab:Keybind({
        Title = "Keybind",
    ...
    UserInputService.InputBegan:Connect(function(input, gameProcessed)
        if not gameProcessed and input.KeyCode == CurrentKey then
            local newState = not _G.AimbotConfig.Enabled
            if ToggleAim and ToggleAim.SetValue then
                ToggleAim:SetValue(newState)
            else
                _G.AimbotConfig.Enabled = newState
            end
        end
    end)
...
function RemoteChat:Send(Message)
    task.spawn(function()
        ...
        -- Usa a variável TextChatService já definida
        ...
        if not sent then
            -- Usa a variável Replicated já definida
            ...
            if running then
                task.spawn(function()
                    ...
                    if selectedMode == "JJ (Delta)" then
                        ...
                        local remote = Replicated:WaitForChild("Remotes"):WaitForChild("Polichinelos")
                        remote:FireServer("Prepare")
                    ...
                    for num = i, limit, step do
                        ...
                        if selectedMode == "JJ (Delta)" then
                            Replicated:WaitForChild("Remotes"):WaitForChild("Polichinelos"):FireServer("Add", 1)
...
do
    local Enabled = false
    local HashtagMode = false
    local InstructorName = ""
    local BaseYaw = 0
    local Connections = {}
    
    -- Tabela de comandos personalizados
    -- Exemplo: { {trigger = "VIRAR DIREITA", action = "right"}, ... }
    ...
    -- Variável temporária para o input de custom command
    local TempCustomCmd = ""

    -- Funções Utilitárias
    local function notify(t, c)
        -- Assume que a função Notify existe globalmente ou foi passada
        if Notify then Notify(t, c) end
    end
    ...
    local function isAllUpper(msg)
        -- Se for hashtag, ignoramos essa checagem
        if msg:match("^#+$") then return true end
        return msg == msg:upper()
    end

    local function normalizeCompact(msg)
        return msg:upper():gsub("%s+", ""):gsub("[^A-Z!]", "")
    end
    ...
    local function enqueue(action, label)
        ...
        notify("Auto volver's", "Executando: " .. label)
    ...
    local function processAction(actionType, label)
        if actionType == "right" then
            enqueue(function() smoothRotate(-math.rad(rand(80, 100))) end, label or "DIREITA")
        elseif actionType == "left" then
            enqueue(function() smoothRotate(math.rad(rand(80, 100))) end, label or "ESQUERDA")
        elseif actionType == "back" then
            enqueue(function() smoothRotate(math.rad(rand(170, 190))) end, label or "RETAGUARDA")
        elseif actionType == "front" then
            enqueue(returnBase, label or "VANGUARDA")
        end
    end

    local function handle(msg)
        -- 1. Verifica Comandos Personalizados primeiro
        for _, cmd in ipairs(CustomCommands) do
            if msg == cmd.trigger or msg:upper() == cmd.trigger:upper() then
                processAction(cmd.action, "Custom: " .. cmd.trigger)
                return
            end
        end

        -- 2. Lógica Hashtag (Bypassed Filter)
        if HashtagMode and msg:match("^#+$") then
            local len = #msg
            -- Tamanhos baseados em letras maiúsculas + exclamação
            -- Com Espaço: "DIREITA VOLVER!" (15 chars)
            -- Sem Espaço: "DIREITAVOLVER!" (14 chars)
            
            -- Definindo tamanhos esperados
            local sizeRight = SuffixSpaced and 15 or 14
            local sizeLeft = SuffixSpaced and 16 or 15
            local sizeBack = SuffixSpaced and 18 or 17
            local sizeFront = SuffixSpaced and 17 or 16

            if len == sizeRight then processAction("right", "### (Dir)") return end
            if len == sizeLeft then processAction("left", "### (Esq)") return end
            if len == sizeBack then processAction("back", "### (Ret)") return end
            if len == sizeFront then processAction("front", "### (Van)") return end
        end

        -- 3. Verificações padrões
        if not isAllUpper(msg) then return end
        
        -- Verifica sufixo (exclamação)
        local hasSpace = msg:find(" !", 1, true)
        local hasExcl = msg:find("!", 1, true)
        
        local valid = false
        if SuffixSpaced then
            if hasSpace then valid = true end
        else
            if hasExcl and not hasSpace then valid = true end
        end
        ...
        if compact == "DIREITAVOLVER!" then processAction("right", "Padrão")
        elseif compact == "ESQUERDAVOLVER!" then processAction("left", "Padrão")
        elseif compact == "RETAGUARDAVOLVER!" then processAction("back", "Padrão")
        elseif compact == "VANGUARDAVOLVER!" then processAction("front", "Padrão")
        end
    end

    -- Lógica de Hooks (Chat)
    local function isInstructor(plrName)
        if InstructorName == "" then return false end
        -- Autocomplete: Verifica se o nome digitado está contido no nome do player
        return string.find(plrName:lower(), InstructorName:lower(), 1, true) ~= nil
    end

    local function hookLegacyChat()
        for _, plr in ipairs(Players:GetPlayers()) do
            local conn = plr.Chatted:Connect(function(msg)
                if Enabled and isInstructor(plr.Name) then handle(msg) end
            end)
    ...
    local function hookTextChat()
        ...
        if typeof(signal) ~= "RBXScriptSignal" then hookLegacyChat() return end
        local conn = signal:Connect(function(message)
            ...
            if plr and isInstructor(plr.Name) then handle(message.Text) end
        end)
        table.insert(Connections, conn)
    end
    ...
    Volvers:Input({
        Title = "Instrutor (Autocomplete)",
        Desc = "Digite parte do nome. Ex: 'Tevez' detecta 'TevezSupreme'",
    ...
    Volvers:Toggle({
        ...
        Desc = "Liga/Desliga o Auto Volver.",
        Value = false,
        Callback = function(v)
            Enabled = v
    ...
    Volvers:Toggle({
        ...
        Desc = "ON: 'DIREITA VOLVER !' | OFF: 'DIREITA VOLVER!'",
        Value = false,
        Callback = function(v)
            SuffixSpaced = v
        end
    ...
    Volvers:Toggle({
        Title = "Modo Hashtag (Anti-Tag)",
        Desc = "Detecta comandos mesmo se ficarem '####'. Baseado no tamanho da frase.",
        Value = false,
        Callback = function(v)
            HashtagMode = v
        end
    ...
    local CustomListParagraph -- Referência futura para atualizar a lista

    local function UpdateList()
        local str = ""
        if #CustomCommands == 0 then
            str = "Nenhum comando adicionado."
        else
            for i, cmd in ipairs(CustomCommands) do
                str = str .. i .. ". [" .. cmd.trigger .. "] -> " .. cmd.action:upper() .. "\n"
            end
        end
        if CustomListParagraph then
            CustomListParagraph:SetDesc(str)
        end
    end

    Volvers:Input({
        Title = "Criar Comando Personalizado",
        Desc = "Digite o texto do comando e clique num botão abaixo para adicionar.",
        Value = "",
        Placeholder = "Ex: MEIA VOLTA",
        Callback = function(v) 
            TempCustomCmd = v 
        end
    })
    ...
    Volvers:Paragraph({
        Title = "Adicionar Ação ao Comando",
        Desc = "Define o que o texto acima fará.",
        Buttons = {
            {
                Title = "+ Direita",
                Callback = function()
                    if TempCustomCmd ~= "" then
                        table.insert(CustomCommands, {trigger = TempCustomCmd, action = "right"})
                        notify("Config", "Adicionado Direita: " .. TempCustomCmd)
                        UpdateList()
                    end
                end
            },
            {
                ...
                Callback = function()
                    if TempCustomCmd ~= "" then
                        table.insert(CustomCommands, {trigger = TempCustomCmd, action = "left"})
                        notify("Config", "Adicionado Esquerda: " .. TempCustomCmd)
                        UpdateList()
                    end
                end
            },
            {
                ...
                Callback = function()
                    if TempCustomCmd ~= "" then
                        table.insert(CustomCommands, {trigger = TempCustomCmd, action = "back"})
                        notify("Config", "Adicionado Retaguarda: " .. TempCustomCmd)
                        UpdateList()
                    end
                end
            },
            {
                ...
                Callback = function()
                    if TempCustomCmd ~= "" then
                        table.insert(CustomCommands, {trigger = TempCustomCmd, action = "front"})
                        notify("Config", "Adicionado Vanguarda: " .. TempCustomCmd)
                        UpdateList()
                    end
                end
            }
    ...
    CustomListParagraph = Volvers:Paragraph({
        Title = "Lista de Comandos Criados",
        Desc = "Nenhum comando adicionado.",
        Buttons = {
            {
                Title = "Limpar Tudo",
                Callback = function()
...
do
    local TevezLocal = TevezApenas:Tab({
        Title = "Local",
        Icon = "lucide:user-round",
        IconColor = Color3.fromHex("#3262A8")
    })

local Message = ""
local Spamming = false

local Input = TevezLocal:Input({
    Title = "Mensagem",
    Desc = "Digite a mensagem para enviar no chat",
    Value = "",
...
local Toggle = TevezLocal:Toggle({
    Title = "Spam",
    Desc = "Envia a mensagem várias vezes",
    Icon = "lucide:check",
    Type = "Checkbox",
    Value = false,
    Callback = function(state) 
        ...
        if state then
            task.spawn(function()
                while Spamming do
                    Replicated.Assets.Remotes.ForceChat:FireServer(Message)
                    task.wait(0.1)
                end
            end)
        end
...
local Button = TevezLocal:Button({
    Title = "Enviar",
...
local AFKRemote = Replicated
	:WaitForChild("Assets")
	:WaitForChild("Remotes")
	:WaitForChild("AFK")

local Dropdown = TevezLocal:Dropdown({
	Title = "AFK",
	Desc = "Modo AFK",
	Values = { "Ativar", "Desativar" },
	Value = "",
	Callback = function(option)
		if option == "Ativar" then
			AFKRemote:FireServer(true)
		elseif option == "Desativar" then
...
local function TeleportTo(targetPart)
    ...
    if char then
        ...
        if root then
            -- Sistema Anti-Queda (BodyVelocity)
...
-- Loop de Monitoramento de Dinheiro
task.spawn(function()
    while true do
        if IsFarming then
            local dados = LocalPlayer:FindFirstChild("Dados")
...
task.spawn(function()
    while true do
        if IsFarming then
            local char = LocalPlayer.Character
            -- Verifica se o personagem está vivo e carregado
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/michigun-log/logs/refs/heads/main/registro"))()
--logs 
