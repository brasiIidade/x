...
do
    ...
    if TEVEZ_MAPA then
        table.insert(jjTypes, "JJ Canguru")
    end
            ...
            if running then
                task.spawn(function()
                    ...
                    if selectedMode == "JJ (Delta)" then
                        ...
                        game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Polichinelos"):FireServer(unpack(argsPrep))
                        
                        local argsStart = {"Start"}
                        game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Polichinelos"):FireServer(unpack(argsStart))
                    end
                    ...
                    for num = i, limit, step do
                        ...
                        if selectedMode == "JJ (Delta)" then
                            ...
                            local args = {"Add", 1}
                            game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Polichinelos"):FireServer(unpack(args))
                        ...
                        elseif selectedMode == "JJ Canguru" then
                            -- 1. Enviar mensagem
                            ...
                            -- 8. Gira o personagem usando TweenService e CFrame.fromOrientation
                            if Char.Root then
                                local targetRot = math.random(350, 370)
                                local rotationInRadians = math.rad(targetRot)
                                
                                local tween = TweenService:Create(
                                    Char.Root, 
                                    TweenInfo.new(0.5), 
                                    {["CFrame"] = Char.Root.CFrame * CFrame.fromOrientation(0, rotationInRadians, 0)}
                                )
                                tween:Play()
                            end
