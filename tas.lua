...
-- Novas variáveis globais de cor/opacidade
...
-- Função para atualizar cores/transparência em tempo real
...
tas.UpdateSelection = function(sL)
    ...
    -- task.spawn suavizado com wait() para não travar o jogo
    task.spawn(function()
        for i, n in ipairs(tas.Selection) do
            ...
            if i % 2 == 0 then task.wait() end -- Previne o travamento
        end
