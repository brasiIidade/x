...
do
    ...
    do
        ...
        VisSection:Dropdown({ Title = "Posição", Desc = "Modifica a posição do FOV", Values = { "Mouse", "Center" }, Value = defaultFOVBehavior, Flag = "PosicaoFOV", Callback = function(v) SC.FOVBehavior = v end })
