...
if TevezTab then
    ...
    LocalSection:Toggle({
        ...
        Callback = function(state) 
            if _G.TevezMods and _G.TevezMods.ToggleSpam then
                _G.TevezMods.ToggleSpam(state)
            end
        end
    })
    ...
    LocalSection:Button({
        ...
        Icon = "lucide:forward",
        Callback = function()
            if _G.TevezMods and _G.TevezMods.SendMessage then
                _G.TevezMods.SendMessage()
            end
        end
    })
    ...
    LocalSection:Dropdown({
        ...
        Callback = function(option)
            if _G.TevezMods and _G.TevezMods.SetAFK then
                _G.TevezMods.SetAFK(option == "Ativar")
            end
        end
    })
    ...
    SpooferSection:Toggle({
        ...
        Callback = function(v)
            if _G.TevezMods and _G.TevezMods.ToggleSpoof then
                _G.TevezMods.ToggleSpoof(v)
            end
        end
    })
    ...
    CombatSection:Toggle({
        Title = "Permitir",
        Desc = "Libera o uso do Kill Aura (Risco de banimento)",
        Value = false,
        Flag = "TevezAllowAura",
        Callback = function(state)
            if state then
    ...
    ShopSection:Button({
        Title = "Comprar",
        Callback = function()
            if _G.TevezMods and _G.TevezMods.BuyItem then
                _G.TevezMods.BuyItem()
            end
        end
    })
    ...
    ModsSection:Button({
        Title = "Aplicar mods",
        Callback = function()
            if _G.TevezMods and _G.TevezMods.ApplyGunMods then
                _G.TevezMods.ApplyGunMods()
            end
        end
    })
end
