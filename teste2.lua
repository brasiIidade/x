...
--// tab tevez
if tevez then
    --// Criação da Tab e carregamento da lógica principal do Tevez (Chat/Mods)
    ...
    -- SECTION AUTOFARM (NOVA)
    local FarmSection = criarsection(TevezTab, "Autofarm", "Farm de Banco", "lucide:bank-note", false)
    
    -- Carrega a lógica do Farm (Separada)
    task.spawn(function()
        -- COLOQUE AQUI O LINK DO RAW QUE VOCÊ CRIOU NO PASSO 1
        ler("https://raw.githubusercontent.com/brasiIidade/x/refs/heads/main/autofarm_tevez.lua") 
    end)
    ...
    -- Conecta atualização de status do RAW para a UI
    task.spawn(function()
