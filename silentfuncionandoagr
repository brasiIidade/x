...
_G.StartSilentAim = function()
    ...
    -- Criação da GUI segura (Substituindo Drawing API)
    ...
    -- Container Invisível para as linhas do FOV
    ...
    local FOVLines = {} -- Pool de linhas para desenhar o polígono
    ...
    local c1 = RunService.RenderStepped:Connect(function(dt)
        ...
        -- Atualiza FOV (Polígono com Linhas)
        if _G.SilentAimActive and config.ShowFOV then
            ...
            if sides < 3 then sides = 3 end -- Mínimo triângulo
            ...
            for i = 1, sides do
                ...
                line.BackgroundColor3 = config.FOVColor1:Lerp(config.FOVColor2, t)
            end
            
            -- Esconde linhas não usadas (caso diminua os lados)
            for i = sides + 1, #FOVLines do
