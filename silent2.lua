...
_G.FOVLines = {} -- Tabela para armazenar as linhas do FOV
...
local function getClosestPlayer()
    ...
    for _, Player in IPairs(Players:GetPlayers()) do
        ...
        -- DeathCheck incluso aqui (Health <= 0)
...
-- [[ LÓGICA DE INICIALIZAÇÃO E PARADA ]]
...
_G.StartSilentAim = function()
    ...
    local c1 = RunService.RenderStepped:Connect(function()
        ...
        if _G.SilentAimActive and config.ShowFOV then
            ...
            -- Oculta linhas extras (caso o slider diminua)
            for i = numSides + 1, #_G.FOVLines do
                if _G.FOVLines[i] then _G.FOVLines[i].Visible = false end
            end

            -- Atualiza posição e cor das linhas
            for i = 1, numSides do
                ...
                -- Lógica Gradient (Interpolação entre Color1 e Color2)
            ...
            -- Esconde tudo se o FOV estiver desligado
            if _G.FOVLines then
