...
if _G.AimFOVFill then pcall(function() _G.AimFOVFill:Remove() end) _G.AimFOVFill = nil end -- Limpeza do preenchimento
...
_G.StopSilentAim = function()
    ...
    _G.SilentAimConnections = {}
    if _G.AimFOVCircle then pcall(function() _G.AimFOVCircle:Remove() end) _G.AimFOVCircle = nil end
    if _G.AimFOVFill then pcall(function() _G.AimFOVFill:Remove() end) _G.AimFOVFill = nil end -- Remove preenchimento
    if _G.AimbotGui then _G.AimbotGui:Destroy() _G.AimbotGui = nil end
    if _G.AimHighlight then _G.AimHighlight:Destroy() _G.AimHighlight = nil end
    ClosestHitPart = nil
...
_G.StartSilentAim = function()
    ...
    -- PREENCHIMENTO DO OCTOGONO
    local fov_fill = Drawing.new("Circle")
    fov_fill.Visible = false
    fov_fill.Thickness = 0
    fov_fill.Transparency = 0.15 -- Transparencia da camada interna
