...
if _G.AimFOVFill then pcall(function() _G.AimFOVFill:Remove() end) _G.AimFOVFill = nil end -- Limpeza do Fill adicionada
...
_G.StopSilentAim = function()
    ...
    _G.SilentAimConnections = {}
    if _G.AimFOVCircle then pcall(function() _G.AimFOVCircle:Remove() end) _G.AimFOVCircle = nil end
    if _G.AimFOVFill then pcall(function() _G.AimFOVFill:Remove() end) _G.AimFOVFill = nil end -- Remove o Fill ao parar
    if _G.AimbotGui then _G.AimbotGui:Destroy() _G.AimbotGui = nil end
    if _G.AimHighlight then _G.AimHighlight:Destroy() _G.AimHighlight = nil end
    ClosestHitPart = nil
...
_G.StartSilentAim = function()
    ...
    -- FOV Fill (Vidro/Shade)
    local fov_fill = Drawing.new("Circle")
    fov_fill.Visible = false; fov_fill.Thickness = 0; fov_fill.Transparency = 0.2; fov_fill.Color = config.FOVColor1; fov_fill.Filled = true; fov_fill.NumSides = 64
