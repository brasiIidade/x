...
_G.StartSilentAim = function()
    ...
    HeadBillboard.Size = UDim2.fromOffset(200, 100)
    ...
    TeamLabel.AutomaticSize = Enum.AutomaticSize.X
    TeamLabel.Size = UDim2.new(0, 0, 1, 0)
    ...
    WeaponLabel.Size = UDim2.new(0, 0, 0, 14)
